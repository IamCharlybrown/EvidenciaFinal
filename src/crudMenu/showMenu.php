...
<div class="container  py-5">
  <div class="row mb-4">
    <div class="col">
      <header class="py-3 bg-danger text-center text-white">
        <h1 class="mb-0">Categoria : <?= $menu['id'] ?>
        </h1>
      </header>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col text-end">
      <a class="btn btn-warning" href="editMenu.php?id=<?= $menu['id'] ?>">Editar</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger" href="deleteMenu.php?id=<?= $menu['id']?>">Eliminar</a>
      </div>
    </div>
  </div>
</div>